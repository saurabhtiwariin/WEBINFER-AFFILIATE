...
var BrandService = /** @class */ (function () {
    ...
    BrandService.prototype.loadBrands = function () {
        var _this = this;
        ...
        */
        ...
        this.httpClient.get(this.brandsUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["delay"])(1000)).subscribe(function (brands) {
            console.log("subscribed here..");
            _this.brands$.next({ loading: false, data: brands });
        });
    };
...
//# sourceMappingURL=modules-brands-brands-module-es5.js.map